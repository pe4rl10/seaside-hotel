...
import com.example.seasidehotel.exception.PhotoRetrievalException;
...
import com.example.seasidehotel.service.BookingService;
...
public class RoomController {
    ...
    public ResponseEntity<RoomResponse> updateRoom(@PathVariable Long roomId,
        ...
        byte[] photoBytes = photo != null && !photo.isEmpty() ?
                photo.getBytes() : roomService.getRoomPhotosByRoomId(roomId);
